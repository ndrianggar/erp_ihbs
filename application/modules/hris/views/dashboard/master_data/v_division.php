<div class="card shadow">
  ...
  <div class="table-responsive" id="frmtbDivision">
    <table class="table align-items-center table-flush" id="tbDataDivision">
      <thead class="thead-light">
        <tr>
          <th scope="col">#</th>
          <th scope="col" class="text-center">Kode Divisi</th>
          <th scope="col" class="text-center">Nama Divisi</th>
