<div class="card shadow">
  <div class="card-header border-0">
    ...
    <h3 class="mb-0">Data Position</h3>
  </div>
  <div class="table-responsive" id="frmTbUnit">
    <table class="table align-items-center table-flush" id="tbDataPosition">
      <thead class="thead-light">
        <tr>
          <th scope="col">#</th>
          <th scope="col" class="text-center">Code Position</th>
          <th scope="col" class="text-center">Name Position</th>
  ...
  <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="modal-title-default">Add Position</h3>
