<div class="card shadow">
  <div class="card-header border-0">
    <button class="btn btn-sm btn-primary pull-right" id="btnAddThnAkademik" onclick="add('ThnAkademik')"><i class="fa fa-plus"></i> Tambah</button>
  ...
  <div class="card-footer py-4">
      ...
      <button class="btn btn-warning pull-right" id="btnCancel" style="display: none;" onclick="cancelAdd('ThnAkademik')">Cancel</button>
  </div>
</div>
