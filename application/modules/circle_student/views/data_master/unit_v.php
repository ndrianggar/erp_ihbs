<div class="card shadow">
  <div class="card-header border-0">
    ...
    <h3 class="mb-0">Data Unit Sekolah</h3>
  </div>
  <div class="table-responsive" id="frmTbUnit">
    <table class="table align-items-center table-flush" id="tbDataUnit">
      <thead class="thead-light">
        <tr>
          <th scope="col">#</th>
          <th scope="col" style="text-align: center;">Nama Unit</th>
          <th scope="col"  style="text-align: center;">Aktif / Non Aktif</th>
