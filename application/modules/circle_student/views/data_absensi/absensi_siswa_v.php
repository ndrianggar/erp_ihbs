...
<div class="card shadow" id="mainFormAbsensiSiswa">
  <div class="card-header border-0">
    <h3 class="mb-0">Data Absensi Siswa
      ...
      Bulan 
      <input class="form-control-sm" type="text" name="bulanAbsen" id="bulanAbsen" size="8">
      Tahun Akademik
  ...
  <div class="table-responsive" id="frmAddAbsensiSiswa" style="display: none;">
    <h4 align="center">DAFTAR HADIR SISWA <span id="lbUnit"></span> </h4>
    <h4 align="center"><span id="lbThnP"></span></h4>
    <h4 align="center">KELAS <span id="lbKls"></span> </h4>
    <h4 align="center">BULAN <span id="lbBulan"></span> </h4>
  ...
  <div class="card-footer py-4">
    ...
    <button class="btn btn-warning pull-right" id="btnCancel" style="display: none;" onclick="cancelAdd('AbsensiSiswa'),$('.card-header').show(500)">Cancel</button>
  </div>
</div>
