<body <?php if (!empty($sess_unit)) {echo 'onload="selectUnitSiswaForKls()"';}?>>
<div class="card shadow" id="mainFormSiswa">
  <div class="card-header border-0">
    <button class="btn btn-sm btn-primary pull-right" id="btnPrintSiswa" onclick="printSiswa()"><i class="fa fa-print"></i> Print Siswa</button>
    <button class="btn btn-sm btn-primary pull-right" id="btnImportSiswa" onclick="importSiswa()"><i class="fa fa-upload"></i> Import Siswa</button>
    <button class="btn btn-sm btn-primary pull-right" id="btnAddSiswa" onclick="add('Siswa')"><i class="fa fa-plus"></i> Tambah Siswa</button>
    <h3 class="mb-0">Data Siswa <?php echo $this->session->userdata("unit")?>
      <select class="form-control-sm" id="selectUnit" onchange="selectUnitSiswa()" <?php if (!empty($sess_unit)) { echo 'style=display:none'; }?>>
        <option selected="selected" value="">Pilih Unit *</option>
      </select>
      Kelas
      <select class="form-control-sm" id="selectKlsParalel" onchange="dataTbSiswa()">
        <option selected="selected" value="">Pilih Kelas *</option>
      </select>
    </h3>
  </div>
  <div class="table-responsive" id="frmTbSiswa">
    <table class="table align-items-center table-flush" id="tbSiswa">
  ...
  <div class="container" id="frmImportSiswa" style="display: none;">
    <div class="nav-wrapper">
      <form id="importDataSiswa">
        <a href="<?php echo base_url('assets/file_format/format_siswa.xlsx') ?>" ><button class="btn btn-success" type="button"><i class="fa fa-download"></i> Download Format Excel</button></a>
        <input type="file" name="excel_siswa" style="height:50px">
    </div>
  </div>
  <div class="card-footer py-4">
    <button type="submit" class="btn btn-success pull-right ml-3" id="btnImport" style="display: none;">Import</button>
    <button type="button" class="btn btn-warning pull-right" id="btnCancelImport" style="display: none;" onclick="cancelAdd('Siswa')">Cancel</button>
    </form>
  </div>
  <div class="container" id="frmAddSiswa" style="display: none;">
    <div class="nav-wrapper">
      <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
        <li class="nav-item show" id="ds1" onclick="changeData('ds1')">
          <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#input-siswa" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">Data Siswa</a>
        </li>
      ...
      <form id="saveDataSiswa">
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="input-siswa" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
          <div class="row">
            <div class="col-lg-6">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" class="form-control form-control-alternative" placeholder="Nama Siswa">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="file" id="photo_siswa" name="photo_siswa" class="form-control form-control-alternative" placeholder="photo">
              </div>
            </div>
          </div>
          </div>
          ...
          <!-- <div class="mb-sm-3 pull-right">
            <button type="button" class="btn btn-warning" id="btnCancelEdit" onclick="cancelEditDataSiswa()" style="display: none;">CANCEL</button>
    ...
    <div class="card-footer py-4">
        ...
        <button type="button" class="btn btn-warning pull-right" id="btnCancel" style="display: none;" onclick="cancelAdd('Siswa')">Cancel</button>
        </form>
    </div>
  </div> 

  <div class="container-fluid" style="display: none;" id="formDetailSiswa">
    <div class="card card-profile shadow">
      ...
      <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
          <a href="#" class="btn btn-sm btn-default mr-4 float-left" onclick="backPreviewSiswa()"><i class="fa fa-angle-left"></i> Back</a>
          <a href="#" class="btn btn-sm btn-default float-right" style="margin-left:10px;" onclick="editDataSiswa()"><i class="fa fa-edit text-info"></i> Edit</a>
        ...
        <div class="nav-wrapper">
          <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
            <li class="nav-item show" id="ds" onclick="changeData('ds')">
              <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">Data Siswa</a>
            </li>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 29%;">
                      <span id="lbNmSiswa"></span>
                      <div class="form-group">
                        <input type="text" value="" class="form-control form-control-alternative" style="display:none;" name="edit_nmSiswa" id="edit_nmSiswa"/>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="file" class="form-control form-control-alternative" name="edit_photo_siswa" id="edit_photo" style="display: none;">
                    </td>
                  </tr>
                </tbody>
              </table>
