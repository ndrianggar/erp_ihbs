                ...
                <form role="form">
                  ...
                  <div class="form-group" id="pass_form">
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Password" type="password" id="pass"  onkeypress="login(event)">
                    </div>
                  </div>
                  ...
                  <div class="text-center">
                    <button type="button" class="btn btn-primary my-4" onclick="btnLogin();" style="width: 100%;">Log in</button>
                  </div>
                </form>
              </div>
            </div>
