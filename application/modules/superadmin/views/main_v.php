...
<head>
  ...
  <meta name="author" content="IHBS Dev">
...
<body>
  <!-- Sidenav -->
  <nav class="navbar navbar-vertical navbar-expand-md " id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0 mr-2" href="<?php echo base_url('circle_student/admin') ?>">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2018 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">IHBS</a>
            </div>
          </div>
        </div>
      </footer>
