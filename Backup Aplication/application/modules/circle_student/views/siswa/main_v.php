...
<body>
  <header class="header-global">
    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent bg-ungugitu navbar-light headroom">
      <div class="container">
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item">
              <?php if (empty($this->session->userdata("nama"))) {?>
                <a href="<?php echo base_url('circle_student/login');?>" class="nav-link nav-link-icon">
