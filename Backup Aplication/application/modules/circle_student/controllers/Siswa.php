 <?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	Class Siswa extends CI_Controller{
		public function __construct(){
            ...
            {
                  $this->template->load("siswa/main_v","siswa/home_v");
      	}
      	...
      	public function check_login()
      	{
            ...
            public function profile()
            {
                  ...
                  $dt_siswa = $this->Main_model->getDataSiswa($id);
                  ...
                  $this->template->load("siswa/main_v","siswa/profile_v",$data);
            }
            ...
            {
                  $this->template->load("siswa/main_v","siswa/library_v");
            }
	}
?>