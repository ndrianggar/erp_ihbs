...
--
-- Host: localhost
-- Generation Time: 24 Sep 2019 pada 14.54
-- Versi Server: 5.7.27-0ubuntu0.16.04.1
...
CREATE TABLE `tb_cabang` (
  `id_cbg` int(50) NOT NULL,
  `nm_cbg` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_fakultas_krywn` (
...
CREATE TABLE `tb_karyawan` (
  ...
  `id_jabatan` int(30) NOT NULL,
  `id_cbg` int(50) NOT NULL,
  `id_nm_pekerjaan` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_karyawan` (`nip`, `nama`, `ktp`, `nm_pnggilan`, `agama`, `gender`, `gol_darah`, `unit`, `alamat`, `rt`, `rw`, `desa`, `kecamatan`, `kota`, `kd_pos`, `no_tlp`, `email`, `tempat_lahir`, `tgl_lahir`, `nik`, `npwp`, `kewarganegaraan`, `status_nikah`, `jml_anak`, `nm_ibu`, `mulai_tugas`, `pendidikan`, `nm_college`, `thn_lulus`, `nm_sekolah`, `jurusan`, `ipk`, `mulai_brgbg`, `masa_kerja`, `status_pegawai`, `photo_pegawai`, `nmr_darurat1`, `nm_nmr_darurat1`, `nm_nmr_darurat2`, `nmr_darurat2`, `relasi`, `deleted`, `id_divisi`, `id_jabatan`, `id_cbg`, `id_nm_pekerjaan`) VALUES
('123', 'Choyrul Annam', '', '', 'Islam', 'Laki-laki', 'O', 'SMP PUTRA', 'Taman Balaraja', '01', '02', 'Munjul', 'Ciracas', 'Jakarta Timur', '13850', '08121212323', 'test@gmail.com', 'tangerang1', '2018-11-01', '123', '123', 'Indonesia', 'Single', 0, 'Ummu Fulan', '2018-07-31', 'S1', '', 2016, 'UI', 'Information System', '4.0', NULL, NULL, 'non', 'ca4a27bb71d5a7661eae0107be346e09.jpg', '', '', '', '', '', 'false', 0, 0, 0, 0);
...
--
ALTER TABLE `tb_slider`
  MODIFY `id_slider` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
