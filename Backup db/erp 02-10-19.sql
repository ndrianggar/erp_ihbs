...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Okt 2019 pada 08.42
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `tb_absen_siswa` (
...
CREATE TABLE IF NOT EXISTS `tb_cabang` (
  `id_cbg` varchar(50) NOT NULL,
  `nm_cbg` varchar(50) NOT NULL
...
INSERT INTO `tb_cabang` (`id_cbg`, `nm_cbg`) VALUES
('CBG00001', 'MUNJUL');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_cbt`
--

CREATE TABLE IF NOT EXISTS `tb_cbt` (
`kd_cbt` int(11) NOT NULL,
  `kd_jenis_cbt` int(11) NOT NULL,
  `unit` varchar(30) NOT NULL,
  `kd_kls` varchar(10) NOT NULL,
  `kd_mapel` varchar(20) NOT NULL,
  `nm_cbt` varchar(100) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_cbt`
--

INSERT INTO `tb_cbt` (`kd_cbt`, `kd_jenis_cbt`, `unit`, `kd_kls`, `kd_mapel`, `nm_cbt`, `user`, `last_update`, `deleted`) VALUES
(1, 1, 'SMP PUTRA', 'VII', 'MP001/BI/VII', 'Test', 2012804166, '2019-09-09 08:52:57', 'false'),
(2, 1, 'SMP PUTRA', 'VII', 'MP001/BI/VII', 'Test', 2012804166, '2019-09-09 08:52:57', 'false');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_college_krywn`
--

CREATE TABLE IF NOT EXISTS `tb_college_krywn` (
`id_colloge_krywn` int(50) NOT NULL,
  `nm_college_krywn` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_divisi` (`id_divisi`, `nm_divisi`) VALUES
('DIV0001', 'Yayasan');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_fakultas_krywn`
--

CREATE TABLE IF NOT EXISTS `tb_fakultas_krywn` (
`id_fakultas_krywn` int(50) NOT NULL,
  `nm_fakultas_krywn` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(10, '2012804166', '2012804166', '', 'Tangerang', '2000-12-02', 'Laki-laki', 'Islam', 'SMP', 'VII', '1', NULL, 'Kristen', 'Taman Balaraja', '21252', '2', '3', 'Parahu', 'Sukamulya', 'Tangerang', '15610', 'Non', '0', '', '123456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'SMP PUTRA', 'false'),
...
--
-- Struktur dari tabel `tb_guru1`
--

CREATE TABLE IF NOT EXISTS `tb_guru1` (
`kd_guru` int(11) NOT NULL,
  `nip` varchar(50) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_guru1`
--
...
--
-- Struktur dari tabel `tb_id_sekolah`
--

CREATE TABLE IF NOT EXISTS `tb_id_sekolah` (
...
--
-- Dumping data untuk tabel `tb_id_sekolah`
--
...
(10, '12121', '', '', '', 0, '', '', '', '', '', '', '', '', 'true'),
(11, '', '', '', '', 0, '', '', '', '', '', '', '', '', 'true'),
(12, 'SD Ibnu Hajar ', '123', '123', 'Jakarta Timur', 123, '123', '123', '123', '123', '123', 'ucok@gmail.com', '123', 'SD', 'false');
...
INSERT INTO `tb_jabatan` (`id_jabatan`, `nm_jbtn`) VALUES
('JB0001', 'Ketua Yayasan');
...
--
-- Struktur dari tabel `tb_jenis_cbt`
--

CREATE TABLE IF NOT EXISTS `tb_jenis_cbt` (
`kd_jenis_cbt` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_jenis_cbt`
--
...
--
-- Struktur dari tabel `tb_job_title`
--

CREATE TABLE IF NOT EXISTS `tb_job_title` (
`id_job_title` int(25) NOT NULL,
...
--
-- Struktur dari tabel `tb_jurusan_krywn`
--

CREATE TABLE IF NOT EXISTS `tb_jurusan_krywn` (
`id_jurusan_krywn` int(50) NOT NULL,
  `nm_jurusan_krywn` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tb_karyawan` (
  ...
  `nm_pnggilan` varchar(30) NOT NULL,
  ...
  `nm_college` varchar(30) NOT NULL,
  `thn_lulus` year(4) NOT NULL,
  `nm_sekolah` varchar(50) NOT NULL,
  `jurusan` varchar(50) NOT NULL,
  `ipk` varchar(5) NOT NULL,
  `mulai_brgbg` datetime(6) DEFAULT NULL,
  `masa_kerja` datetime(6) DEFAULT NULL,
  `status_pegawai` varchar(30) NOT NULL,
  `photo_pegawai` text NOT NULL,
  `nmr_darurat1` varchar(30) NOT NULL,
  `nm_nmr_darurat1` varchar(30) NOT NULL,
  `nm_nmr_darurat2` varchar(30) NOT NULL,
  `nmr_darurat2` varchar(30) NOT NULL,
  `relasi` varchar(30) NOT NULL,
  `deleted` enum('false','true') NOT NULL DEFAULT 'false',
  `id_divisi` varchar(50) NOT NULL,
  `id_jabatan` varchar(50) NOT NULL,
  `id_cbg` varchar(50) NOT NULL,
  `id_job_title` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_karyawan` (`nip`, `nama`, `ktp`, `nm_pnggilan`, `agama`, `gender`, `gol_darah`, `unit`, `alamat`, `rt`, `rw`, `desa`, `kecamatan`, `kota`, `kd_pos`, `no_tlp`, `email`, `tempat_lahir`, `tgl_lahir`, `nik`, `npwp`, `kewarganegaraan`, `status_nikah`, `jml_anak`, `nm_ibu`, `mulai_tugas`, `pendidikan`, `nm_college`, `thn_lulus`, `nm_sekolah`, `jurusan`, `ipk`, `mulai_brgbg`, `masa_kerja`, `status_pegawai`, `photo_pegawai`, `nmr_darurat1`, `nm_nmr_darurat1`, `nm_nmr_darurat2`, `nmr_darurat2`, `relasi`, `deleted`, `id_divisi`, `id_jabatan`, `id_cbg`, `id_job_title`) VALUES
('123', 'Choyrul Annam', '', '', 'Islam', 'Laki-laki', 'O', 'SMP PUTRA', 'Jl. Mushola Fathul Ulum No.11', '01', '02', 'Munjul', 'Ciracas', 'Jakarta Timur', '13850', '08121212323', 'test@gmail.com', 'tangerang1', '1998-11-01', '123', '123', 'Indonesia', 'Single', 0, 'Ummu Fulan', '2018-07-31', 'S1', '', 2016, 'UI', 'Information System', '4.0', NULL, NULL, 'non', 'MUHAMAD_ABDUL_SYUKUR.jpg', '', '', '', '', '', 'false', 'DIV0001', 'JB0001', 'CBG00001', '0'),
('345', 'Arief', '', '', 'Islam', 'Laki-laki', 'O', 'SMP PUTRA', 'Jl. Mushola Fathul Ulum No.11', '01', '02', 'Munjul', 'Ciracas', 'Jakarta Timur', '13850', '08121212323', 'test@gmail.com', 'tangerang1', '1998-11-01', '123', '123', 'Indonesia', 'Single', 0, 'Ummu Fulan', '2018-07-31', 'S1', '', 2016, 'UI', 'Information System', '4.0', NULL, NULL, 'non', 'MUHAMAD_ABDUL_SYUKUR.jpg', '', '', '', '', '', 'false', 'DIV0001', 'JB0001', 'CBG00001', '0'),
('678', 'Ulul Albab Spd.i', '', '', 'Islam', 'Laki-laki', 'O', 'SMP PUTRA', 'Jl. Mushola Fathul Ulum No.11', '01', '02', 'Munjul', 'Ciracas', 'Jakarta Timur', '13850', '08121212323', 'test@gmail.com', 'tangerang1', '1998-11-01', '123', '123', 'Indonesia', 'Single', 0, 'Ummu Fulan', '2018-07-31', 'S1', '', 2016, 'UI', 'Information System', '4.0', NULL, NULL, 'non', 'Ust Ulul Albab.jpg', '', '', '', '', '', 'false', 'DIV0001', 'JB0001', 'CBG00001', '0');
...
--
-- Struktur dari tabel `tb_kelompok_mapel`
--

CREATE TABLE IF NOT EXISTS `tb_kelompok_mapel` (
...
--
-- Struktur dari tabel `tb_kls_paralel`
--

CREATE TABLE IF NOT EXISTS `tb_kls_paralel` (
`kd_kls_paralel` int(11) NOT NULL,
  `kd_kls` varchar(10) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_kls_paralel`
--
...
INSERT INTO `tb_kurikulum` (`kd_kurikulum`, `nm_kurikulum`, `status`, `deleted`, `last_update`) VALUES
(1, '2016', 'aktif', 'false', '2019-09-03 14:20:32'),
(2, '2013', 'aktif', 'false', '2019-09-03 13:49:52'),
(3, '2014', 'aktif', 'false', '2019-09-03 13:54:42'),
(4, '2015', 'aktif', 'false', '2019-09-03 13:55:45'),
(5, '', 'aktif', 'true', '2019-09-06 14:14:32');
...
CREATE TABLE IF NOT EXISTS `tb_predikat` (
...
(1, 1, 'Kelas 1', 30, 'SD', 'false'),
(2, 5, 'test', 20, 'SD', 'true'),
(3, 1, 'test', 21, 'SD', 'true'),
(4, 1, 'Ruang A', 30, 'SMP PUTRA', 'false');
...
(0, 0, '', '', '', '0000-00-00', '', '', 'Pilih Kela', 0, NULL, 0, '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, 'Aktif', 'false'),
...
(2012804166, 201545113, '2012804166', 'Choyrul Annam', 'Tangerang', '2019-06-30', 'Laki-laki', 'Islam', 'VII', 1, NULL, 2, 'SMP PUTRA', 'Taman Balaraja', '2', '3', 'Parahu', 'Sukamulya', 'Tangerang', '15610', 'Non', '0', '1323653', '212525323', NULL, 'e10adc3949ba59abbe56e057f20f883e', 'Aktif', 'false');
...
INSERT INTO `tb_slider` (`id_slider`, `nm_slider`, `gambar`, `keterangan`, `urutan`, `status`) VALUES
(17, 'Promosi Circle 1', '', 'versi ukuran 1280 x 450 px', '1', 'active'),
(18, 'Promosi Circle  2', '13d53c943f3f7d5ae1a93dcd71ebe917.png', 'versi ukuran 1280 x 450 px', '2', 'non_active'),
(19, 'Promosi Circle  3', '752872c092b217b5f11b9f99ef06d493.png', 'versi ukuran 1280 x 450 px', '3', 'non_active'),
(20, 'Promosi Circle  4', '5712d212ec20619aea9e5e9589e79757.png', 'versi ukuran 1280 x 450 px', '4', 'non_active');
...
(3, 'MP003/BA/VII', 1, 0, 'Siapa yang akan memenangkan pilpres', 'siapa aja boleh', '100', '111', '2019-05-01 06:55:12', 'true');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_soal_pg`
--

CREATE TABLE IF NOT EXISTS `tb_soal_pg` (
...
--
-- Dumping data untuk tabel `tb_soal_pg`
--
...
CREATE TABLE IF NOT EXISTS `tb_sub_materi` (
...
--
-- Struktur dari tabel `tb_thn_akademik`
--

CREATE TABLE IF NOT EXISTS `tb_thn_akademik` (
`kd_thn_akademik` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_thn_akademik`
--
...
--
-- Struktur dari tabel `tb_topik_soal`
--

CREATE TABLE IF NOT EXISTS `tb_topik_soal` (
`kd_topik_soal` int(11) NOT NULL,
  `kd_mapel` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_topik_soal`
--
...
INSERT INTO `tb_unit` (`kd_unit`, `unit`, `status`, `deleted`) VALUES
(1, 'SD', 'nonaktif', 'false'),
(2, 'SMP PUTRA', 'aktif', 'false'),
(3, 'SMA', 'aktif', 'false'),
(4, 'SMP PUTRI', 'aktif', 'false');
...
(1, 111, 'superadmin', '2637a5c30af69a7bad877fdb65fbd78b', 'superadmin', 'IT', '1', 'false'),
...
(8, 2012804166, '2012804166', 'e10adc3949ba59abbe56e057f20f883e', 'akademik', 'Guru', '3', 'false'),
(9, 2012206166, 'new', '202cb962ac59075b964b07152d234b70', 'akademik', 'Admin', '1', 'false');
...
--
-- Indexes for table `tb_cbt`
--
ALTER TABLE `tb_cbt`
 ADD PRIMARY KEY (`kd_cbt`);

--
-- Indexes for table `tb_college_krywn`
--
ALTER TABLE `tb_college_krywn`
 ADD PRIMARY KEY (`id_colloge_krywn`);

--
-- Indexes for table `tb_fakultas_krywn`
--
ALTER TABLE `tb_fakultas_krywn`
 ADD PRIMARY KEY (`id_fakultas_krywn`);
...
--
-- Indexes for table `tb_jurusan_krywn`
--
ALTER TABLE `tb_jurusan_krywn`
 ADD PRIMARY KEY (`id_jurusan_krywn`);
...
--
-- AUTO_INCREMENT for table `tb_cbt`
--
ALTER TABLE `tb_cbt`
MODIFY `kd_cbt` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tb_college_krywn`
--
ALTER TABLE `tb_college_krywn`
MODIFY `id_colloge_krywn` int(50) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_fakultas_krywn`
--
ALTER TABLE `tb_fakultas_krywn`
MODIFY `id_fakultas_krywn` int(50) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tb_id_sekolah`
MODIFY `kd_sekolah` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `tb_job_title`
MODIFY `id_job_title` int(25) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tb_jurusan_krywn`
--
ALTER TABLE `tb_jurusan_krywn`
MODIFY `id_jurusan_krywn` int(50) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tb_kurikulum`
MODIFY `kd_kurikulum` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tb_ortu`
MODIFY `kd_ortu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=43;
--
...
--
ALTER TABLE `tb_ruangan`
MODIFY `kd_ruangan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_slider`
--
ALTER TABLE `tb_slider`
MODIFY `id_slider` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `tb_unit`
MODIFY `kd_unit` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
